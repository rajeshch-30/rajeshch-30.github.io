...
var Commands = /*#__PURE__*/function (_CommandsBackwardsCom) {
  ...
  function Commands() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), 'classes', {
      get: function get() {
        elementorCommon.helpers.softDeprecated('$e.commands.classes', '3.7.0', '$e.commands.getCommandClass(), $e.commandsInternal.getCommandClass(), $e.data.getCommandClass(), $e.routes.getCommandClass() according to the requested command infra-structure,');
...
var ComponentBase = /*#__PURE__*/function (_Module) {
  ...
  (0, _createClass2.default)(ComponentBase, [{
    ...
    value: function getRootContainer() {
      elementorCommon.helpers.softDeprecated('getRootContainer()', '3.7.0', 'getServiceName()');
